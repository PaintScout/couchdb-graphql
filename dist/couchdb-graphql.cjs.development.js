...
var base = {
  typeDefs:
  /*#__PURE__*/
  apolloServerCore.gql(templateObject_1 || (templateObject_1 =
  /*#__PURE__*/
      ...
      switch (_b.label) {
          ...
          , fetch(dbUrl + "/" + dbName + "/_bulk_get", {
            ...
            body: JSON.stringify({
              docs: documentsWithConflictRevs.reduce(function (conflicts, doc) {
                return tslib.__spreadArrays(conflicts, (doc && doc._conflicts || []).map(function (rev) {
                  return {
                    id: doc._id,
                    rev: rev
                  };
        ...
        case 2:
          ...
          result = documentsWithConflictRevs.reduce(function (result, doc) {
            ...
            if (conflicts) {
              return tslib.__assign(tslib.__assign({}, result), (_a = {}, _a[doc._id] = tslib.__assign(tslib.__assign({}, result[doc._id]), {
                conflicts: tslib.__spreadArrays(result[doc._id].conflicts, conflicts)
              }), _a));
            }
    ...
    return tslib.__generator(this, function (_b) {
      switch (_b.label) {
              ...
              return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    if (resolvedDocument) {
                      resolved = tslib.__rest(resolvedDocument, ["_conflicts"]);
                      return [2
                      /*return*/
                      , tslib.__assign(tslib.__assign({}, resolved), {
        ...
        case 2:
          ...
          docsToSave = tslib.__spreadArrays(resolvedDocs, Object.keys(conflictingDocuments).reduce(function (deleted, docId) {
            return tslib.__spreadArrays(deleted, conflictingDocuments[docId].conflicts.map(function (conflict) {
              return tslib.__assign(tslib.__assign({}, conflict), {
                _deleted: true
              });
        ...
        case 3:
          ...
          resolvedDocuments = response.filter(function (result) {
            ...
            return tslib.__assign(tslib.__assign({}, docsToSave.find(function (doc) {
      ...
      switch (_d.label) {
        ...
        case 4:
          ...
          , fetch(url, {
            ...
            body: JSON.stringify({
              docs: [tslib.__assign(tslib.__assign({}, doc), {
                _rev: rev
              })],
              new_edits: new_edits
            })
        ...
        case 5:
          ...
          if (result) {
            savedDocument = tslib.__assign(tslib.__assign({}, doc), {
              _id: result.id,
              _rev: result.rev
            });
...
var typeDefs =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$1 || (templateObject_1$1 =
/*#__PURE__*/
          ...
          , fetch(url, {
            ...
            body: JSON.stringify({
              docs: docs.map(function (doc) {
                ...
                var docToSave = tslib.__assign(tslib.__assign({}, doc), {
...
var typeDefs$1 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$2 || (templateObject_1$2 =
/*#__PURE__*/
...
function allDocs(context, _a) {
  ...
  var keys = _a.keys,
      ...
      args = tslib.__rest(_a, ["keys", "key", "endkey", "startkey"]);
...
var typeDefs$2 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$3 || (templateObject_1$3 =
/*#__PURE__*/
...
var typeDefs$3 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$4 || (templateObject_1$4 =
/*#__PURE__*/
...
var typeDefs$4 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$5 || (templateObject_1$5 =
/*#__PURE__*/
...
function query(context, _a) {
  var view = _a.view,
      ...
      key = _a.key,
      keys = _a.keys,
      options = tslib.__rest(_a, ["view", "ddoc", "key", "keys"]);
...
function search(context, _a) {
  var index = _a.index,
      ddoc = _a.ddoc,
      options = tslib.__rest(_a, ["index", "ddoc"]);
...
var typeDefs$5 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$6 || (templateObject_1$6 =
/*#__PURE__*/
...
var typeDefs$6 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$7 || (templateObject_1$7 =
/*#__PURE__*/
tslib.__makeTemplateObject(["\n  type GetResponse {\n    _id: String!\n    _rev: String\n    document: JSON\n  }\n\n  extend type Query {\n    get(\n      id: String!\n      rev: String\n      revs: Boolean\n      revs_info: Boolean\n      open_revs: Boolean\n      conflicts: Boolean\n      attachments: Boolean\n      latest: Boolean\n    ): GetResponse\n  }\n"], ["\n  type GetResponse {\n    _id: String!\n    _rev: String\n    document: JSON\n  }\n\n  extend type Query {\n    get(\n      id: String!\n      rev: String\n      revs: Boolean\n      revs_info: Boolean\n      open_revs: Boolean\n      conflicts: Boolean\n      attachments: Boolean\n      latest: Boolean\n    ): GetResponse\n  }\n"])));
var resolvers$6 = {
  Query: {
...
var typeDefs$7 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$8 || (templateObject_1$8 =
/*#__PURE__*/
...
var typeDefs$8 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$9 || (templateObject_1$9 =
/*#__PURE__*/
tslib.__makeTemplateObject(["\n  type QueryResponse {\n    offset: Int\n    update_seq: JSON\n    total_rows: Int\n    rows: [QueryRow!]\n  }\n\n  type QueryRow {\n    id: String\n    key: JSON\n    value: JSON\n  }\n\n  extend type Query {\n    query(\n      ddoc: String!\n      view: String!\n      conflicts: Boolean\n      descending: Boolean\n      endkey: JSON\n      group: Boolean\n      group_level: Int\n      include_docs: Boolean\n      attachments: Boolean\n      att_encoding_info: Boolean\n      inclusive_end: Boolean\n      key: JSON\n      keys: [JSON!]\n      limit: Int\n      reduce: Boolean\n      skip: Int\n      sorted: Boolean\n      stable: Boolean\n      stale: String\n      startkey: JSON\n      update: String\n      update_seq: Boolean\n    ): QueryResponse\n  }\n"], ["\n  type QueryResponse {\n    offset: Int\n    update_seq: JSON\n    total_rows: Int\n    rows: [QueryRow!]\n  }\n\n  type QueryRow {\n    id: String\n    key: JSON\n    value: JSON\n  }\n\n  extend type Query {\n    query(\n      ddoc: String!\n      view: String!\n      conflicts: Boolean\n      descending: Boolean\n      endkey: JSON\n      group: Boolean\n      group_level: Int\n      include_docs: Boolean\n      attachments: Boolean\n      att_encoding_info: Boolean\n      inclusive_end: Boolean\n      key: JSON\n      keys: [JSON!]\n      limit: Int\n      reduce: Boolean\n      skip: Int\n      sorted: Boolean\n      stable: Boolean\n      stale: String\n      startkey: JSON\n      update: String\n      update_seq: Boolean\n    ): QueryResponse\n  }\n"])));
var resolvers$8 = {
  Query: {
...
var typeDefs$9 =
/*#__PURE__*/
apolloServerCore.gql(templateObject_1$a || (templateObject_1$a =
/*#__PURE__*/
...
function createCouchDbModule(_a, moduleConfig) {
  var cloudant = _a.cloudant,
      options = tslib.__rest(_a, ["cloudant"]); // separate cloudant queries from couchdb


  var couchdbQueries = tslib.__rest(queries // combine typeDefs
  , ["search"]); // combine typeDefs


  var typeDefs = tslib.__spreadArrays([base.typeDefs], Object.keys(cloudant ? queries : couchdbQueries).map(function (key) {
  ...
  var resolvers = tslib.__spreadArrays(Object.keys(cloudant ? queries : couchdbQueries).map(function (key) {
  ...
  return new core.GraphQLModule(tslib.__assign(tslib.__assign({}, options), {
    typeDefs: typeDefs,
    resolvers: resolvers
  }), moduleConfig);
}
